...
/*
1. Crie uma coleção de artistas com suas músicas ordenadas por data de lançamento. Inclua o
total de músicas em uma propriedade separada.
...
JsonSerializer.Serialize(arquivoJson, artistas, optionsJson);

System.Console.WriteLine("Serialização concluída");
